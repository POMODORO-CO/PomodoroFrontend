...
function InfoProyecto() {
    ...
    console.log('la data del proyecto ', dataP);
    return (
                                            ...
                                            <div className="w-full max-w-2xl m-6">
                                                <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                                                    ...
                                                    <div className="mb-4">
                                                        ...
                                                        <input className="shadow appearance-none border-blue-900 border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder={u._id} disabled="disabled" />
                                                    </div>
                                                    <div className="mb-4">
                                                        <label className="block text-blue-900 text-sm font-bold py-1" htmlFor="username">
                                                            Nombre del Proyecto

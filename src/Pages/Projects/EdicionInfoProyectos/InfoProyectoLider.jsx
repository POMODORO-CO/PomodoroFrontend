                                                ...
                                                <div className="flex items-center flex-col text-middle ">
                                                    ...
                                                    <div>
                                                        ...
                                                        {tooglePendientes == true ?
                                                            <>
                                                            <div className="flex flex-col justify-center md:flex-row pb-4 mb-4">
                                                                <button onClick={() => cambioToogle()} className="mx-3 py-2 px-5 text-white font-bold rounded-full bg-blue-900 shadow-lg block md:inline-block"> Ver estudiantes aprobados </button>
                                                                <NavLink to={`/private/Proyecto/Avances/${dataP.Proyecto._id}`} className="mx-3 py-2 px-5 text-white font-bold rounded-full bg-blue-900 shadow-lg block md:inline-block">Avances del proyecto</NavLink>
                                                            </div>
                                                            </>
                                                            : <>
                                                            <div className="flex flex-col justify-center md:flex-row pb-4 mb-4">
                                                                <button onClick={() => cambioToogle()} className="mx-3 py-2 px-5 text-white font-bold rounded-full bg-blue-900 shadow-lg block md:inline-block">Ver estudiantes pendiente por aprobación</button>
                                                            </div>
                                                            </>
                                                        }
                                                    </div>

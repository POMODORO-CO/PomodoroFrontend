...
function Registro() {
  ...
  }, [mutationData,mutationError, setToken, navigate])
        ...
        <form className="w-full max-w-lg" onSubmit={submitForm} onChange={updateFormData} ref={form}>
          ...
          <div className="flex flex-wrap -mx-3 mb-2">
            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <input name='passwordUsuario' className="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-2 px-3 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-password" type="password" placeholder="***********" />
              <p className="text-red-500 text-xs">Por favor diligencie los datos.</p>
            </div>
            <div className="w-full md:w-1/2 px-3">
              <label className="text-white text-sm font-bold mb-2" htmlFor="grid-segundo-nombre">
